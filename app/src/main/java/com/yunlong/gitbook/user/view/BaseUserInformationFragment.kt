...
import com.yunlong.gitbook.user.behavior.UserBehavior
 ...
 * 所有的Fragment
 */
open class BaseUserInformationFragment : BaseFragment(R.layout.f_user_information), View.OnClickListener, UserContract.View {
    /**
     * 伴生对象
     */
    companion object {
        ...
        var mBehavior: UserBehavior? = null

        fun newInstance(): BaseUserInformationFragment {
            val fragment = BaseUserInformationFragment();
            return fragment;
        }
    }
    ...
    fun initData() {
        mBehavior?.initData(this, mPresenter)
    }
